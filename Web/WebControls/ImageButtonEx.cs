...
{
    [ToolboxData("<{0}:ImageButtonEx runat=server></{0}:ImageEx>")]
    public partial class ImageButtonEx : ImageButton, System.Web.UI.IScriptControl
    {
        ...
        {
            yield return new ScriptReference(Page.ClientScript.GetWebResourceUrl(typeof(ImageButtonEx),
