<%@ Page Language="C#" MasterPageFile="~/TotalGiroClient.master" CodeFile="Charts.aspx.cs" Inherits="Charts"%>
    ...
    <asp:UpdatePanel ID="updTabs" runat="server">
        <ContentTemplate>
            ...
            <ajaxtoolkit:TabContainer runat="server" ID="tbcChartType" AutoPostBack="true" ActiveTabIndex="0" 
                ...
                <ajaxToolkit:TabPanel runat="server" ID="tbpPortfolio" HeaderText="Portefeuille">
                    <ContentTemplate>

                        <div style="min-height: 532px">
                            <asp:Panel ID="pnlPortfolio" runat="server" Visible="true">
                            
                                <asp:CheckBoxList ID="cblPortfolioAccounts" runat="server" DataSourceID="odsPortfolioAccounts"
                                    DataTextField="DisplayNumberWithName" DataValueField="Key" AutoPostBack="True"
                                    OnDataBound="cblPortfolioAccounts_DataBound" RepeatDirection="Horizontal" RepeatColumns="3" 
                                    OnSelectedIndexChanged="cblPortfolioAccounts_SelectedIndexChanged" Height="22px">
                                </asp:CheckBoxList>
                                <asp:ObjectDataSource ID="odsPortfolioAccounts" runat="server" SelectMethod="GetContactAccounts"
                                ...
                                <div style="height: 510px">
                                    <dundas:Chart ID="chPortfolioValuations" runat="server" BorderLineColor="26, 59, 105"
                ...
                <ajaxToolkit:TabPanel runat="server" ID="tbpPositions" HeaderText="Posities" Height="510px">
                    <ContentTemplate>
                    
                        <div style="min-height: 532px">
                            <asp:Panel ID="pnlPositions" runat="server" Visible="false">
                            
                                <asp:RadioButtonList ID="rblPositionsAccounts" runat="server" AutoPostBack="True"
                                    DataSourceID="odsPositionsAccounts" DataTextField="DisplayNumberWithName" DataValueField="Key"
                                    RepeatDirection="Horizontal" RepeatColumns="3"
                                    OnDataBound="rblPositionsAccounts_DataBound" Height="22px">
                                </asp:RadioButtonList>
                                <asp:ObjectDataSource ID="odsPositionsAccounts" runat="server" SelectMethod="GetContactAccounts"
                                    TypeName="B4F.TotalGiro.ClientApplicationLayer.Common.CommonAdapter">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="contactId" SessionField="ContactId" Type="Int32" DefaultValue="0" /> 
                                    </SelectParameters>
                                ...
                                <asp:ObjectDataSource ID="odsPositionInstruments" runat="server" SelectMethod="GetAccountPositions"
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="rblPositionsAccounts" Name="accountId" PropertyName="SelectedValue" Type="Int32" />
                                    </SelectParameters>
                                </asp:ObjectDataSource>
                                
                                <div style="height: 510px">
                                    <dundas:Chart ID="chPositionsValuations" runat="server" BorderLineColor="26, 59, 105"
                                        Palette="DundasDark" Width="850px" Height="500px" AntiAliasing="Graphics" 
                                        BorderLineWidth="0">
                    ...
                    <ContentTemplate>
                        ...
                        <div style="min-height: 532px">
                            <asp:Panel ID="pnlAllocation" runat="server" Visible="false">
                                ...
                                <asp:RadioButtonList ID="rblAllocationAccounts" runat="server" AutoPostBack="True"
                                    DataSourceID="odsAllocationAccounts" DataTextField="DisplayNumberWithName" DataValueField="Key"
                                    RepeatDirection="Horizontal" RepeatColumns="3"
                                    OnDataBound="rblAllocationAccounts_DataBound" Height="22px">
                                </asp:RadioButtonList>
