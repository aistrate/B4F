<%@ Page Title="" Language="C#" MasterPageFile="~/TotalGiroClient.master" CodeFile="ClientPortfolios.aspx.cs" Inherits="ClientPortfolios" %>
        ...
        <b4f:MultipleSelectionGridView ID="gvClients" runat="server" DataSourceID="odsClients" AutoGenerateColumns="False" DataKeyNames="Key" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Accounts">
                    <ItemStyle Wrap="False" HorizontalAlign="Left" Width="260px" />
                    <HeaderStyle wrap="False" HorizontalAlign="Left" />
                    <ItemTemplate>
