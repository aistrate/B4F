...
public partial class Reconciliation_ReconHistorical : System.Web.UI.Page
{
    ...
    { 
        if (!IsPostBack)
        {
            ((EG)this.Master).setHeaderText = "External Reconciliations";
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string reportPath = "/ReconCurrent/ReconExternal";
        string format = "PDF";
        ...
        parameters[0].Value = DatePicker1.SelectedDate.ToString();
