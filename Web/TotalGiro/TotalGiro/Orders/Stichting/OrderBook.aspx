<%@ Page Language="C#" MasterPageFile="~/EG.master" AutoEventWireup="true" CodeFile="OrderBook.aspx.cs" Inherits="Orders_Stichting_OrderBook" Title="Order Book"  Theme="Neutral"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" Runat="Server">
    ...
    <table cellpadding="0" cellspacing="5" border="0" style="width: 419px">
        <tr>
            <td style="vertical-align: middle; text-align: right; width: 271px; height: 24px;">
        ...
        <tr>
            <td colspan="3" />
            <td style="vertical-align: middle; text-align: right; width: 145px;">
                <asp:Label ID="lblInstrumentName" runat="server" Text="Instrument Name" Width="126px"></asp:Label>
            </td>
            <td style="width: 230px">
        ...
        <tr>
            <td style="vertical-align: middle; text-align: right; width: 271px;">
            ...
            <td />
            <td style="vertical-align: middle; text-align: right; width: 145px;">
                <asp:Label ID="lblSecurityCategory" runat="server" Text="Security Category">
                </asp:Label>
            </td>
            <td style="width: 230px">
        ...
        <tr>
            <td style="height: 26px; vertical-align: middle; text-align: right; width: 271px;">
            ...
            <td>
                <asp:GridView 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Owner" SortExpression="Account_AccountOwner_CompanyName">
                            <ItemTemplate>
                                <asp:Label ID="lblOwner" runat="server" Text='<%# Abbreviation((DataBinder.Eval(Container.DataItem, "Account_AccountOwner_CompanyName")).ToString(), 20) %>'
                                    ToolTip='<%# DataBinder.Eval(Container.DataItem, "Account_AccountOwner_CompanyName") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Wrap="False" />
                        </asp:TemplateField>
                        <asp:TemplateField 
