...
public partial class Orders_AssetManager_OrderBook : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ((EG)this.Master).setHeaderText = "Order Book";
        }
    }
    ...
    protected void btnRefresh_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtOrderID.Text == string.Empty && txtAccountNr.Text == string.Empty && txtAccountName.Text == string.Empty && txtIsin.Text == string.Empty && txtInstrumentName.Text == string.Empty && ddlSecCategory.SelectedIndex == 0 && cldDateFrom.IsEmpty && cldDateTo.IsEmpty)
