...
public partial class ServiceDeskAdHocWithdrawalManagement: System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Utility.SetDefaultButton(Page, (DropDownList)ctlAccountFinder.FindControl("ddlAssetManager"), btnSearch);
        ...
        if (!IsPostBack)
        {
            ((EG)this.Master).setHeaderText = "Ad-Hoc Withdrawal Management Console";
            gvInstructionOverview.Sort("WithdrawalDate", SortDirection.Ascending);
            ViewState["InsertMode"] = false;
        }
