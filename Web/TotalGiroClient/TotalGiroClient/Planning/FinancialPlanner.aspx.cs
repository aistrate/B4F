...
namespace B4F.TotalGiro.Client.Web.Planning
{
    public partial class FinancialPlanner : System.Web.UI.Page
    {
        ...
        private void displayExtras()
        {
            try
            {
                lnkChoiceOfExtras.Visible = true;
                ...
                switch (ExtrasSelectedIndex)
                {
                    case 0:
                        ...
                        lnkChoiceOfExtras.Visible = ProposedPeriodical != 0m || ProposedInitial != 0m;
                        break;
        ...
        protected decimal TrafficLightValue
        {
            set
            {
                imgTrafficLight.ImageUrl = string.Format("~/Images/TrafficLight/Set2/{0}-light.jpg",
