<%@ Page Language="C#" MasterPageFile="~/TotalGiroClient.master" 
         Inherits="B4F.TotalGiro.Client.Web.Portfolio.PositionTxsCash" Codebehind="PositionTxsCash.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" Runat="Server">
    ...
    <asp:GridView ID="gvCashMutations" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="odsCashMutations" PageSize="50" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DisplayAmount" HeaderText="Bedrag" SortExpression="AmountQuantity">
    ...
    <asp:ObjectDataSource ID="odsCashMutations" runat="server" SelectMethod="GetCashMutations" SortParameterName="sortColumn"
