...
namespace B4F.TotalGiro.Client.Web.UC
{
    public partial class AccountFinder : System.Web.UI.UserControl
    {
        ...
        protected DisplayType AssetManagerDisplayType
        {
            get
            {
                return CurrentLoginTypeIsOneOf(LoginTypes.StichtingEmployee, LoginTypes.ComplianceEmployee) ?
        ...
        protected DisplayType RemisierDisplayType
        {
            get
            {
                return CurrentLoginTypeIsOneOf(LoginTypes.StichtingEmployee, LoginTypes.ComplianceEmployee, LoginTypes.AssetManagerEmployee) ?
                              DisplayType.SelectionList :
                              DisplayType.Label;
            }
        }
        ...
        protected DisplayType RemisierEmployeeDisplayType
        {
            get
            {
                return CurrentLoginType != LoginTypes.Customer ?
                              DisplayType.SelectionList :
                              DisplayType.Label;
            }
        }
